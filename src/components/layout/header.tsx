      ...
      <div className="px-[5%]">
        <div className="flex h-24 items-center justify-between">
          <div className="flex items-center">
            <Link href={routes.HOME} className="flex items-center gap-2 text-2xl font-bold text-white font-fredoka">
              <LogoIcon />
              Pazzell
            </Link>
          </div>
          ...
          <nav className="hidden lg:flex items-center space-x-8">
            {userType === 'gamer' ? (
              <>
                <Link href={routes.USER.DASHBOARD} className="text-white hover:text-secondary font-medium transition-colors">
                  Dashboard
                </Link>
                <Link href={routes.CAMPAIGNS} className="text-white hover:text-secondary font-medium transition-colors">
                  Campaigns
                </Link>
                <Link href={routes.LEADERBOARD} className="text-white hover:text-secondary font-medium transition-colors">
                  Leaderboard
                </Link>
              ...
              <>
                 <Link href={routes.HOME} className="text-white hover:text-secondary font-medium transition-colors">
                  Home
                </Link>
                <Link href={routes.CAMPAIGNS} className="text-white hover:text-secondary font-medium transition-colors">
                  Campaigns
            ...
            {userType ? (
              ...
              <div className="lg:flex items-center space-x-2 hidden ">
                ...
                <Link href={`${routes.REGISTER}?type=brand`}>
                  <Button 
                    className="bg-gradient-to-r from-[#6C5CE7] to-[#FF6B9D] text-white font-semibold rounded-full hover:shadow-lg hover:-translate-y-1 transition-all duration-300 text-base font-fredoka py-5 px-7"
                  >
                    Create Campaign
                  </Button>
                </Link>
                ...
                <>
                  ...
                  <div className="border-t border-white/10 pt-4 flex flex-col space-y-2">
                    ...
                    <Link href={`${routes.REGISTER}?type=brand`} onClick={closeMobileMenu}>
                      <Button 
                        className="w-full bg-gradient-to-r from-[#6C5CE7] to-[#FF6B9D] text-white font-fredoka"
                      >
                        Create Campaign
                      </Button>
                    </Link>
